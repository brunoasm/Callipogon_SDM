...
#SBATCH -t 0-05:00:00 # Runtime in minutes
#SBATCH -p serial_requeue # Partition to submit to
#SBATCH --mem=10000 # Memory per cpu in MB (see also --mem-per-cpu)
#SBATCH -o SDM_Callipogon_projections.out # stdout and stderr go to this file
...
Rscript --no-restore plot_projections_lonlat.R  
